...
/**
 * This class defines the structure of the 'publisher_tbl' table.
 *
 *
 *
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'publisher_tbl';
     ...
     */
    const PUBLISHER_ID = 'publisher_tbl.PUBLISHER_ID';

    /**
     * the column name for the NAME field
     */
    const NAME = 'publisher_tbl.NAME';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('PublisherId', 'Name', ),
        self::TYPE_STUDLYPHPNAME => array('publisherId', 'name', ),
        self::TYPE_COLNAME       => array(PublisherTableMap::PUBLISHER_ID, PublisherTableMap::NAME, ),
        self::TYPE_RAW_COLNAME   => array('PUBLISHER_ID', 'NAME', ),
        self::TYPE_FIELDNAME     => array('publisher_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('PublisherId' => 0, 'Name' => 1, ),
        self::TYPE_STUDLYPHPNAME => array('publisherId' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(PublisherTableMap::PUBLISHER_ID => 0, PublisherTableMap::NAME => 1, ),
        self::TYPE_RAW_COLNAME   => array('PUBLISHER_ID' => 0, 'NAME' => 1, ),
        self::TYPE_FIELDNAME     => array('publisher_id' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        $this->addRelation('UserPublisher', '\\UserPublisher', RelationMap::ONE_TO_MANY, array('publisher_id' => 'publisher_id', ), null, null, 'UserPublishers');
        $this->addRelation('Book', '\\Book', RelationMap::ONE_TO_MANY, array('publisher_id' => 'publisher_id', ), null, null, 'Books');
    } // buildRelations()
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PublisherId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PublisherTableMap::PUBLISHER_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PublisherTableMap::PUBLISHER_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PublisherTableMap::PUBLISHER_ID) && $criteria->keyContainsValue(PublisherTableMap::PUBLISHER_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.PublisherTableMap::PUBLISHER_ID.')');
        }
