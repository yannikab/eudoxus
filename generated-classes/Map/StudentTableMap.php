...
/**
 * This class defines the structure of the 'student_tbl' table.
 *
 *
 *
...
class StudentTableMap extends TableMap
{
     ...
     */
    const USER_ID = 'student_tbl.USER_ID';

    /**
     * the column name for the GROUP_ID field
     */
    const GROUP_ID = 'student_tbl.GROUP_ID';

    /**
     * the column name for the DEPT_ID field
     */
    const DEPT_ID = 'student_tbl.DEPT_ID';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(StudentTableMap::USER_ID, StudentTableMap::GROUP_ID, StudentTableMap::DEPT_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(StudentTableMap::USER_ID => 0, StudentTableMap::GROUP_ID => 1, StudentTableMap::DEPT_ID => 2, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(StudentTableMap::USER_ID);
            $criteria->addSelectColumn(StudentTableMap::GROUP_ID);
            $criteria->addSelectColumn(StudentTableMap::DEPT_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(StudentTableMap::USER_ID, (array) $values, Criteria::IN);
        }

        $query = StudentQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { StudentTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { StudentTableMap::removeInstanceFromPool($singleval);
            }
        }
