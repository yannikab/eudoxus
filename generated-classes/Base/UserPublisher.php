...
abstract class UserPublisher implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserPublisherTableMap';
    ...
    /**
     * Initializes internal state of Base\UserPublisher object.
     */
    ...
    /**
     * Compares this with another <code>UserPublisher</code> instance.  If
     * <code>obj</code> is an instance of <code>UserPublisher</code>, delegates to
     * <code>equals(UserPublisher)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return UserPublisher The current object, for fluid interface
     */
     ...
     * @return   \UserPublisher The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserPublisherTableMap::USER_ID;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = UserPublisherTableMap::GROUP_ID;
        }
    ...
    public function setPublisherId($v)
    {
        ...
        if ($this->publisher_id !== $v) {
            $this->publisher_id = $v;
            $this->modifiedColumns[] = UserPublisherTableMap::PUBLISHER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserPublisherTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserPublisherTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserPublisherTableMap::translateFieldName('PublisherId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = UserPublisherTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \UserPublisher object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserPublisherQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserPublisher::setDeleted()
     * @see UserPublisher::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildUserPublisherQuery::create()
    ...
    public function save(ConnectionInterface $con = null, $skipReload = false)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserPublisherTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserPublisherTableMap::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(UserPublisherTableMap::GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'GROUP_ID';
        }
        if ($this->isColumnModified(UserPublisherTableMap::PUBLISHER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PUBLISHER_ID';
        }

        $sql = sprintf(
            'INSERT INTO userpublisher_tbl (%s) VALUES (%s)',
    ...
    {
        $pos = UserPublisherTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserPublisher'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserPublisher'][$this->getPrimaryKey()] = true;
        $keys = UserPublisherTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPublisherTableMap::USER_ID)) $criteria->add(UserPublisherTableMap::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserPublisherTableMap::GROUP_ID)) $criteria->add(UserPublisherTableMap::GROUP_ID, $this->group_id);
        if ($this->isColumnModified(UserPublisherTableMap::PUBLISHER_ID)) $criteria->add(UserPublisherTableMap::PUBLISHER_ID, $this->publisher_id);
    ...
    {
        $criteria = new Criteria(UserPublisherTableMap::DATABASE_NAME);
        $criteria->add(UserPublisherTableMap::USER_ID, $this->user_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserPublisher (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \UserPublisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            $this->aUser->setUserPublisher($this);
        }
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGroup->addUserPublishers($this);
             */
        }
    ...
    public function getPublisher(ConnectionInterface $con = null)
    {
        if ($this->aPublisher === null && ($this->publisher_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPublisher->addUserPublishers($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserPublisherTableMap::DEFAULT_STRING_FORMAT);
    }
