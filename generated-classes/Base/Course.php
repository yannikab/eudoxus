...
abstract class Course implements ActiveRecordInterface
{
     ...
     *
     * @return Course The current object, for fluid interface
     */
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = CourseTableMap::COURSE_ID;
        }
    ...
    public function setDeptId($v)
    {
        ...
        if ($this->dept_id !== $v) {
            $this->dept_id = $v;
            $this->modifiedColumns[] = CourseTableMap::DEPT_ID;
        }

        if ($this->aSemester !== null && $this->aSemester->getDeptId() !== $v) {
            $this->aSemester = null;
        }
    ...
    public function setPeriod($v)
    {
        ...
        if ($this->period !== $v) {
            $this->period = $v;
            $this->modifiedColumns[] = CourseTableMap::PERIOD;
        }

        if ($this->aSemester !== null && $this->aSemester->getPeriod() !== $v) {
            $this->aSemester = null;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = CourseTableMap::NAME;
        }
    ...
    public function setStaff($v)
    {
        ...
        if ($this->staff !== $v) {
            $this->staff = $v;
            $this->modifiedColumns[] = CourseTableMap::STAFF;
        }
    ...
    public function setEcts($v)
    {
        ...
        if ($this->ects !== $v) {
            $this->ects = $v;
            $this->modifiedColumns[] = CourseTableMap::ECTS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CourseTableMap::translateFieldName('CourseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->course_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CourseTableMap::translateFieldName('DeptId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dept_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CourseTableMap::translateFieldName('Period', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CourseTableMap::translateFieldName('Staff', TableMap::TYPE_PHPNAME, $indexType)];
            $this->staff = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CourseTableMap::translateFieldName('Ects', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ects = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            throw new PropelException("Error populating \Course object", 0, $e);
        }
    }
    ...
    {
        if ($this->aSemester !== null && $this->dept_id !== $this->aSemester->getDeptId()) {
            $this->aSemester = null;
        }
        if ($this->aSemester !== null && $this->period !== $this->aSemester->getPeriod()) {
            $this->aSemester = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->course_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CourseTableMap::COURSE_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CourseTableMap::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'COURSE_ID';
        }
        if ($this->isColumnModified(CourseTableMap::DEPT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DEPT_ID';
        }
        if ($this->isColumnModified(CourseTableMap::PERIOD)) {
            $modifiedColumns[':p' . $index++]  = 'PERIOD';
        }
        if ($this->isColumnModified(CourseTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(CourseTableMap::STAFF)) {
            $modifiedColumns[':p' . $index++]  = 'STAFF';
        }
        if ($this->isColumnModified(CourseTableMap::ECTS)) {
            $modifiedColumns[':p' . $index++]  = 'ECTS';
        }

        $sql = sprintf(
            'INSERT INTO course_tbl (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'NAME':
                        ...
                        break;
                    case 'STAFF':
                        $stmt->bindValue($identifier, $this->staff, PDO::PARAM_STR);
                        break;
                    case 'ECTS':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setStaff($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CourseTableMap::COURSE_ID)) $criteria->add(CourseTableMap::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(CourseTableMap::DEPT_ID)) $criteria->add(CourseTableMap::DEPT_ID, $this->dept_id);
        if ($this->isColumnModified(CourseTableMap::PERIOD)) $criteria->add(CourseTableMap::PERIOD, $this->period);
        if ($this->isColumnModified(CourseTableMap::NAME)) $criteria->add(CourseTableMap::NAME, $this->name);
        if ($this->isColumnModified(CourseTableMap::STAFF)) $criteria->add(CourseTableMap::STAFF, $this->staff);
        if ($this->isColumnModified(CourseTableMap::ECTS)) $criteria->add(CourseTableMap::ECTS, $this->ects);
    ...
    {
        $criteria = new Criteria(CourseTableMap::DATABASE_NAME);
        $criteria->add(CourseTableMap::COURSE_ID, $this->course_id);
    ...
    /**
     * Generic method to set the primary key (course_id column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setStaff($this->getStaff());
    ...
    {
        if ($this->aSemester === null && ($this->dept_id !== null && $this->period !== null)) {
            $this->aSemester = ChildSemesterQuery::create()->findPk(array($this->dept_id, $this->period), $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSemester->addCourses($this);
             */
        }
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildCourse The current object (for fluent API support)
     */
    public function setCourseBooks(Collection $courseBooks, ConnectionInterface $con = null)
    {
        ...
        foreach ($courseBooksToDelete as $courseBookRemoved) {
            $courseBookRemoved->setCourse(null);
        }
     ...
     * @return Collection|ChildCourseBook[] List of ChildCourseBook objects
     */
    public function getCourseBooksJoinBook($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCourseBookQuery::create(null, $criteria);
     ...
     *
     * @param  ChildBook $book The ChildCourseBook object to relate
     * @return ChildCourse The current object (for fluent API support)
     */
    ...
    protected function doAddBook($book)
    {
        ...
        $courseBook->setBook($book);
        $this->addCourseBook($courseBook);
        // set the back reference to this object directly as using provided method either results
        // in endless loop or in multiple relations
        if (!$book->getCourses()->contains($this)) {
            $foreignCollection   = $book->getCourses();
