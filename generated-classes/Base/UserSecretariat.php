...
abstract class UserSecretariat implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserSecretariatTableMap';
    ...
    /**
     * Initializes internal state of Base\UserSecretariat object.
     */
    ...
    /**
     * Compares this with another <code>UserSecretariat</code> instance.  If
     * <code>obj</code> is an instance of <code>UserSecretariat</code>, delegates to
     * <code>equals(UserSecretariat)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return UserSecretariat The current object, for fluid interface
     */
     ...
     * @return   \UserSecretariat The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserSecretariatTableMap::USER_ID;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = UserSecretariatTableMap::GROUP_ID;
        }
    ...
    public function setDeptId($v)
    {
        ...
        if ($this->dept_id !== $v) {
            $this->dept_id = $v;
            $this->modifiedColumns[] = UserSecretariatTableMap::DEPT_ID;
        }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[] = UserSecretariatTableMap::FIRSTNAME;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[] = UserSecretariatTableMap::LASTNAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserSecretariatTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserSecretariatTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserSecretariatTableMap::translateFieldName('DeptId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dept_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserSecretariatTableMap::translateFieldName('Firstname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->firstname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserSecretariatTableMap::translateFieldName('Lastname', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = UserSecretariatTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \UserSecretariat object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserSecretariatQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserSecretariat::setDeleted()
     * @see UserSecretariat::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildUserSecretariatQuery::create()
    ...
    public function save(ConnectionInterface $con = null, $skipReload = false)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserSecretariatTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserSecretariatTableMap::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(UserSecretariatTableMap::GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'GROUP_ID';
        }
        if ($this->isColumnModified(UserSecretariatTableMap::DEPT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DEPT_ID';
        }
        if ($this->isColumnModified(UserSecretariatTableMap::FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'FIRSTNAME';
        }
        if ($this->isColumnModified(UserSecretariatTableMap::LASTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'LASTNAME';
        }

        $sql = sprintf(
            'INSERT INTO usersecretariat_tbl (%s) VALUES (%s)',
    ...
    {
        $pos = UserSecretariatTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserSecretariat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserSecretariat'][$this->getPrimaryKey()] = true;
        $keys = UserSecretariatTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserSecretariatTableMap::USER_ID)) $criteria->add(UserSecretariatTableMap::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserSecretariatTableMap::GROUP_ID)) $criteria->add(UserSecretariatTableMap::GROUP_ID, $this->group_id);
        if ($this->isColumnModified(UserSecretariatTableMap::DEPT_ID)) $criteria->add(UserSecretariatTableMap::DEPT_ID, $this->dept_id);
        if ($this->isColumnModified(UserSecretariatTableMap::FIRSTNAME)) $criteria->add(UserSecretariatTableMap::FIRSTNAME, $this->firstname);
        if ($this->isColumnModified(UserSecretariatTableMap::LASTNAME)) $criteria->add(UserSecretariatTableMap::LASTNAME, $this->lastname);
    ...
    {
        $criteria = new Criteria(UserSecretariatTableMap::DATABASE_NAME);
        $criteria->add(UserSecretariatTableMap::USER_ID, $this->user_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserSecretariat (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \UserSecretariat Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            $this->aUser->setUserSecretariat($this);
        }
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGroup->addUserSecretariats($this);
             */
        }
    ...
    public function getDepartment(ConnectionInterface $con = null)
    {
        if ($this->aDepartment === null && ($this->dept_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDepartment->addUserSecretariats($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserSecretariatTableMap::DEFAULT_STRING_FORMAT);
    }
