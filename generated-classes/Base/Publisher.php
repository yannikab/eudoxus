...
abstract class Publisher implements ActiveRecordInterface
{
    ...
    public function setPublisherId($v)
    {
        ...
        if ($this->publisher_id !== $v) {
            $this->publisher_id = $v;
            $this->modifiedColumns[] = PublisherTableMap::PUBLISHER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Publisher object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PublisherTableMap::PUBLISHER_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO publisher_tbl (%s) VALUES (%s)',
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setPublisherId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublisherTableMap::PUBLISHER_ID)) $criteria->add(PublisherTableMap::PUBLISHER_ID, $this->publisher_id);
    ...
    {
        $criteria = new Criteria(PublisherTableMap::DATABASE_NAME);
        $criteria->add(PublisherTableMap::PUBLISHER_ID, $this->publisher_id);
    ...
    public function setUserPublishers(Collection $userPublishers, ConnectionInterface $con = null)
    {
        ...
        foreach ($userPublishersToDelete as $userPublisherRemoved) {
            $userPublisherRemoved->setPublisher(null);
        }
    ...
    protected function doAddUserPublisher($userPublisher)
    {
        ...
        $userPublisher->setPublisher($this);
    }
    ...
    public function removeUserPublisher($userPublisher)
    {
        if ($this->getUserPublishers()->contains($userPublisher)) {
            ...
            $userPublisher->setPublisher(null);
        }
     ...
     * @return Collection|ChildUserPublisher[] List of ChildUserPublisher objects
     */
    public function getUserPublishersJoinGroup($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserPublisherQuery::create(null, $criteria);
