...
abstract class Secretariat implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SecretariatTableMap';
    ...
    /**
     * Initializes internal state of Base\Secretariat object.
     */
    ...
    /**
     * Compares this with another <code>Secretariat</code> instance.  If
     * <code>obj</code> is an instance of <code>Secretariat</code>, delegates to
     * <code>equals(Secretariat)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Secretariat The current object, for fluid interface
     */
     ...
     * @return   \Secretariat The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = SecretariatTableMap::USER_ID;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = SecretariatTableMap::GROUP_ID;
        }
    ...
    public function setDeptId($v)
    {
        ...
        if ($this->dept_id !== $v) {
            $this->dept_id = $v;
            $this->modifiedColumns[] = SecretariatTableMap::DEPT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SecretariatTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SecretariatTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SecretariatTableMap::translateFieldName('DeptId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SecretariatTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Secretariat object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSecretariatQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Secretariat::setDeleted()
     * @see Secretariat::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildSecretariatQuery::create()
    ...
    public function save(ConnectionInterface $con = null, $skipReload = false)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SecretariatTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SecretariatTableMap::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(SecretariatTableMap::GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'GROUP_ID';
        }
        if ($this->isColumnModified(SecretariatTableMap::DEPT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DEPT_ID';
        }

        $sql = sprintf(
            'INSERT INTO secretariat_tbl (%s) VALUES (%s)',
    ...
    {
        $pos = SecretariatTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Secretariat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Secretariat'][$this->getPrimaryKey()] = true;
        $keys = SecretariatTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SecretariatTableMap::USER_ID)) $criteria->add(SecretariatTableMap::USER_ID, $this->user_id);
        if ($this->isColumnModified(SecretariatTableMap::GROUP_ID)) $criteria->add(SecretariatTableMap::GROUP_ID, $this->group_id);
        if ($this->isColumnModified(SecretariatTableMap::DEPT_ID)) $criteria->add(SecretariatTableMap::DEPT_ID, $this->dept_id);
    ...
    {
        $criteria = new Criteria(SecretariatTableMap::DATABASE_NAME);
        $criteria->add(SecretariatTableMap::USER_ID, $this->user_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Secretariat (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Secretariat Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            $this->aUser->setSecretariat($this);
        }
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGroup->addSecretariats($this);
             */
        }
    ...
    public function getDepartment(ConnectionInterface $con = null)
    {
        if ($this->aDepartment === null && ($this->dept_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDepartment->addSecretariats($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SecretariatTableMap::DEFAULT_STRING_FORMAT);
    }
