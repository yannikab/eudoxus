...
abstract class CourseBook implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CourseBookTableMap';
    ...
    /**
     * Initializes internal state of Base\CourseBook object.
     */
    ...
    /**
     * Compares this with another <code>CourseBook</code> instance.  If
     * <code>obj</code> is an instance of <code>CourseBook</code>, delegates to
     * <code>equals(CourseBook)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CourseBook The current object, for fluid interface
     */
     ...
     * @return   \CourseBook The current object (for fluent API support)
     */
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = CourseBookTableMap::COURSE_ID;
        }
    ...
    public function setBookId($v)
    {
        ...
        if ($this->book_id !== $v) {
            $this->book_id = $v;
            $this->modifiedColumns[] = CourseBookTableMap::BOOK_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CourseBookTableMap::translateFieldName('CourseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->course_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CourseBookTableMap::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CourseBookTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \CourseBook object", 0, $e);
        }
    }
    ...
    {
        if ($this->aCourse !== null && $this->course_id !== $this->aCourse->getCourseId()) {
            $this->aCourse = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCourseBookQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CourseBook::setDeleted()
     * @see CourseBook::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCourseBookQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CourseBookTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CourseBookTableMap::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'COURSE_ID';
        }
        if ($this->isColumnModified(CourseBookTableMap::BOOK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'BOOK_ID';
        }

        $sql = sprintf(
            'INSERT INTO course_book_tbl (%s) VALUES (%s)',
    ...
    {
        $pos = CourseBookTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CourseBook'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CourseBook'][serialize($this->getPrimaryKey())] = true;
        $keys = CourseBookTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CourseBookTableMap::COURSE_ID)) $criteria->add(CourseBookTableMap::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(CourseBookTableMap::BOOK_ID)) $criteria->add(CourseBookTableMap::BOOK_ID, $this->book_id);
    ...
    {
        $criteria = new Criteria(CourseBookTableMap::DATABASE_NAME);
        $criteria->add(CourseBookTableMap::COURSE_ID, $this->course_id);
        $criteria->add(CourseBookTableMap::BOOK_ID, $this->book_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getCourseId()) && (null === $this->getBookId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CourseBook (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CourseBook Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCourse(ConnectionInterface $con = null)
    {
        if ($this->aCourse === null && ($this->course_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCourse->addCourseBooks($this);
             */
        }
    ...
    public function getBook(ConnectionInterface $con = null)
    {
        if ($this->aBook === null && ($this->book_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBook->addCourseBooks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CourseBookTableMap::DEFAULT_STRING_FORMAT);
    }
