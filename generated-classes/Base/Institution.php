...
abstract class Institution implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InstitutionTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildDepartment[] Collection to store aggregation of ChildDepartment objects.
     */
    ...
    /**
     * Initializes internal state of Base\Institution object.
     */
    ...
    /**
     * Compares this with another <code>Institution</code> instance.  If
     * <code>obj</code> is an instance of <code>Institution</code>, delegates to
     * <code>equals(Institution)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Institution The current object, for fluid interface
     */
    ...
    public function setInstId($v)
    {
        ...
        if ($this->inst_id !== $v) {
            $this->inst_id = $v;
            $this->modifiedColumns[] = InstitutionTableMap::INST_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = InstitutionTableMap::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InstitutionTableMap::translateFieldName('InstId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inst_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InstitutionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = InstitutionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Institution object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInstitutionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Institution::setDeleted()
     * @see Institution::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildInstitutionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InstitutionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[] = InstitutionTableMap::INST_ID;
        if (null !== $this->inst_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . InstitutionTableMap::INST_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(InstitutionTableMap::INST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'INST_ID';
        }
        if ($this->isColumnModified(InstitutionTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }

        $sql = sprintf(
            'INSERT INTO inst_tbl (%s) VALUES (%s)',
    ...
    {
        $pos = InstitutionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = InstitutionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getInstId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setInstId($arr[$keys[0]]);
    ...
    {
        $criteria = new Criteria(InstitutionTableMap::DATABASE_NAME);

        if ($this->isColumnModified(InstitutionTableMap::INST_ID)) $criteria->add(InstitutionTableMap::INST_ID, $this->inst_id);
        if ($this->isColumnModified(InstitutionTableMap::NAME)) $criteria->add(InstitutionTableMap::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(InstitutionTableMap::DATABASE_NAME);
        $criteria->add(InstitutionTableMap::INST_ID, $this->inst_id);
    ...
    /**
     * Generic method to set the primary key (inst_id column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setInstId(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function initDepartments($overrideExisting = true)
    {
        ...
        $this->collDepartments = new ObjectCollection();
        $this->collDepartments->setModel('\Department');
    }

    /**
     * Gets an array of ChildDepartment objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildInstitution is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return Collection|ChildDepartment[] List of ChildDepartment objects
     * @throws PropelException
     */
    public function getDepartments($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collDepartments || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collDepartments) {
                ...
                $collDepartments = ChildDepartmentQuery::create(null, $criteria)
                    ->filterByInstitution($this)
                    ->find($con);
     ...
     *
     * @param      Collection $departments A Propel collection.
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildInstitution The current object (for fluent API support)
     */
    public function setDepartments(Collection $departments, ConnectionInterface $con = null)
    {
        ...
        foreach ($departmentsToDelete as $departmentRemoved) {
            $departmentRemoved->setInstitution(null);
        }
     ...
     * @throws PropelException
     */
    public function countDepartments(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collDepartmentsPartial && !$this->isNew();
        if (null === $this->collDepartments || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collDepartments) {
            ...
            $query = ChildDepartmentQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildDepartment object to this object
     * through the ChildDepartment foreign key attribute.
     *
     * @param    ChildDepartment $l ChildDepartment
     * @return   \Institution The current object (for fluent API support)
     */
    public function addDepartment(ChildDepartment $l)
    {
        if ($this->collDepartments === null) {
            $this->initDepartments();
            $this->collDepartmentsPartial = true;
    ...
    public function clearAllReferences($deep = false)
    {
        ...
        if ($this->collDepartments instanceof Collection) {
    ...
    {
        return (string) $this->exportTo(InstitutionTableMap::DEFAULT_STRING_FORMAT);
    }
